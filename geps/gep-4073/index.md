# GEP-4073: API documentation and readability

* Issue: [#4073](https://github.com/kubernetes-sigs/gateway-api/issues/4073)
* Status: Memorandum
...
fields and structures in a meaningful and concise way, where informations are
...
* Information required by users to properly consume an API - 
